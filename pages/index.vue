  ...
  <main>
        ...
        <div class="grid gap-4 lg:grid-cols-2">
          <div class="flex flex-col items-start gap-2">
            ...
            <p>
              ...
              over a shared love for great food. Join us in creating moments
              that linger on your taste buds and in your memories.
            </p>
          </div>
          <div class="min-h-[530px] overflow-hidden rounded-md">
            <img
              src="~/assets/images/about-us.webp"
              class="w-full h-full object-center object-cover bg-cover bg-center" />
          </div>
        </div>
      </div>
    </section>
    <section class="text-center my-16">
      ...
      <div class="mt-8" id="contact">
        <a class="text-4xl underline text-slate-600" href="tel:+12345678910"
          >+123 45 678 910</a
        >
      </div>
    </section>
